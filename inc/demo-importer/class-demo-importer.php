...
/**
 * Masonic_Demo_Importer Class.
 */
class Masonic_Demo_Importer {
	...
	public function __construct() {
		$this->plugin_data = array(
			...
			'name' => __( 'ThemeGrill Demo importer', 'masonic' ),
		);
	...
	public function add_admin_menu() {
		add_theme_page( __( 'Demo Importer', 'masonic' ), __( 'Demo Importer', 'masonic' ), 'switch_themes', 'demo-importer', array( $this, 'demo_importer' ) );
	}
